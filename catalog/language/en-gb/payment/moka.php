...
$_['PaymentDealer.CheckPaymentDealerAuthentication.VirtualPosNotFound'] = 'Virtual pos definition was not made for this dealer.';
...
$_['PaymentDealer.CheckDealerPaymentLimits.DailyCardLimitExceeded'] = 'Any of the daily limits defined for the dealer have been exceeded.';
$_['PaymentDealer.CheckCardInfo.InvalidCardInfo'] = 'There is an error in the card information.';
$_['PaymentDealer.DoDirectPayment3dRequest.InstallmentNotAvailableForForeignCurrencyTransaction'] = 'Foreign money cannot be made with money.';
$_['PaymentDealer.DoDirectPayment3dRequest.ThisInstallmentNumberNotAvailableForDealer'] = 'This number of installments cannot be made for this dealer.';
$_['PaymentDealer.DoDirectPayment3dRequest.InvalidInstallmentNumber'] = 'The number of installments is between 2 and 12.';
$_['PaymentDealer.DoDirectPayment3dRequest.ThisInstallmentNumberNotAvailableForVirtualPos'] = 'Virtual Pos does not allow this number of installments.';
$_['EX'] = 'An unexpected error has occurred.';
